...
-   **Uganda District Boundaries (2020)**: Geographical boundary data obtained from [geoBoundaries](www.geoboundaries.org), detailing the administrative district boundaries across Uganda.
...
## 3. Digital Connectivity & Literacy
...
## 4A. Financial Literacy (Planning/Budgeting)
...
## 4B. Financial Literacy (Saving Behaviours)
...
## 4C. Financial Literacy (Awareness of Financial Products)
...
## 5A. Financial Inclusion (Insurance Products)
...
## 5B. Financial Inclusion (Savings Mechanisms)
...
## 5C. Financial Inclusion (Remittance Services)
...
## 5D. Financial Inclusion (Payment Channels)
...
## 7. Aggregation to District Level
