...
The `sfdep` package was used to compute the local Moran's I and the LISA quandrant. 1000 simulations were conducted and the alpha value is set at 0.05. Seed is set to ensure reproducibility of results.
The `tmap` package was used to plot three chropleth maps for each economic indicator:
...
Similarly, the `sfdep` package was used to compute the local Gi and classify hot/cold spots. 1000 simulations were conducted and the alpha value is set at 0.05. Seed is set to ensure reproducibility of results.
The `tmap` package was used to plot three chropleth maps for each economic indicator:
