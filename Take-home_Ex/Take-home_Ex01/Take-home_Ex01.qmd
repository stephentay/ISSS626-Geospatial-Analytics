...
In this section, we explore the density of traffic accidents in time (hour of day).
Over here, we calculate the kernel density values in time for several time bandwidths:
